...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      // Get the first error message provided by the backend
      const errorKey = Object.keys(errorData)[0];
      const errorMsg = errorData[errorKey] || 'فشل في إرسال التعليق';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <TouchableOpacity onPress={() => navigation.replace("CardDitals", { from: 'addComment',id })}>
